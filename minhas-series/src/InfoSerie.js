                    ...
                    <div className='h-100 container'>
                        <div className='row h-100 align-items-center'>
                            ...
                            <div className='col-8'>
                                ...
                                Gênero: {data.genre}<br></br>
                                    {data.status === 'ASSISTIDO' && <Badge color='success'>Assistido</Badge>}
                                    {data.status === 'PARA_ASSISTIR' && <Badge className='ml-1' color='warning'>Para Assistir</Badge>}
                                </div>
                                <h3 className='font-weight-light text-white'>{data.comments}</h3>
                            </div>
                        </div>
                    </div>
                </div>
